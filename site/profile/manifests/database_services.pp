class profile::database_services {
  ...
  $db_hash     = hiera_hash('profile::database_services::db_hash')
  $db_defaults = hiera('profile::database_services::db_defaults')
  $enable_firewall = hiera('profile::database_services::enable_firewall')
